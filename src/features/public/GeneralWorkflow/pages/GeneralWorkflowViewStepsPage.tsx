...
export default function GeneralWorkflowViewStepsPage() {
  ...
  const nodes: ApprovalWorkflowNode[] | undefined = generalWorkflow?.ApprovalWorkflowNodes;
    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-3xl font-extrabold text-gray-800">
          Quy trình {generalWorkflow.mainId}
        </h2>
        <button
      ...
      {nodes && nodes.length > 0 ? (
        <div className="flex flex-col md:flex-row gap-12">
          {/* TIMELINE */}
          <div
            className="md:w-1/3 h-[500px] overflow-y-auto relative border-l-4 border-primary pl-8 space-y-12
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-sm mt-1">
                        {GeneralWorkflowStatusLabels[node.approvalStatus]}
                      </p>
                    </div>
                  </li>
                );
                  ...
                  <td className="py-2">
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-semibold 
                        ${
                          nodes[currentNode].approvalStatus === 'APPROVED'
